...
export default function GameRun() {
  ...
  return (<>
    ...
    <div className="d-flex">
      ...
      <p className="p-2 flex-fill">player: {gameState.nowclass instanceof WorkerClass ? <p>WorkerClass</p> : <p>CapitalistClass</p>}</p>
...
const ActionToggle: React.FC<ActionToggleProps> = ({ nowclass, onActionComplete, usedBasicActions, usedfreeActions, setBasicAction, setfreeAction }) => {
  ...
  const actions: Actions = {
    ...
    free: [
      ...
      { label: '发钱', databstarget: 'loan', onClick: () => WorkerClass.getInstance().addincome(100), visibleFor: ['WorkerClass', 'CapitalistClass'], },
    ]
  };
